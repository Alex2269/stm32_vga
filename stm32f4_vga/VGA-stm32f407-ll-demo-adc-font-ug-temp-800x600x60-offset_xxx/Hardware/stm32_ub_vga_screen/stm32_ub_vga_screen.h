...
// extern uint8_t VGA_RAM1[];
extern uint16_t volatile VGA_OFFSET_Y;
...
set (gdb):
set {int}0x4001002C=4
set {int}0x4000002C=1030
set {int}0x4000003C=216
set {int}0x40000040=128

********************************/
//--------------------------------------------------------------
#define  VGA_TIM2_HSYNC_PRESCALE        1
// http://tinyvga.com/vga-timing/800x600@60Hz
#define  VGA_H_Visible_area           800                   // not use
#define  VGA_H_Front_porch             40                   // now not uses
#define  VGA_TIM2_HSYNC_IMP           128                   // Sync pulse (2)
#define  VGA_H_Back_porch              88                   // Back porch
#define  VGA_TIM2_HSYNC_PERIODE      1028                   // Whole line (28.44us)

#define  VGA_TIM2_HTRIGGER_START      VGA_TIM2_HSYNC_IMP+VGA_H_Back_porch  // HSync+BackPorch (5,71us)
#define  VGA_TIM2_DMA_DELAY             0                   // no need
...
//--------------------------------------------------------------
// http://tinyvga.com/vga-timing/800x600@60Hz
#define  VGA_VSYNC_BILD_STOP          600  //  vertical_Visible_area
#define  VGA_V_Front_porch              1  //  now not uses
#define  VGA_VSYNC_IMP                  4  //  vertical Sync pulse
#define  VGA_VSYNC_BILD_START          23  //  vertical Back porch
#define  VGA_VSYNC_PERIODE            628  //  vertical Whole frame
