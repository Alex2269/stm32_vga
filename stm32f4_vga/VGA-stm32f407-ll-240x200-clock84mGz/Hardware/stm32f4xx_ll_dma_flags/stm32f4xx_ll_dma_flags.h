...
static inline
void LL_DMA_ClearFlag_HTx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
void LL_DMA_ClearFlag_TCx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
void LL_DMA_ClearFlag_TEx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
void LL_DMA_ClearFlag_DMEx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
void LL_DMA_ClearFlag_FEx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
uint32_t LL_DMA_IsActiveFlag_HTx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
uint32_t LL_DMA_IsActiveFlag_TCx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
uint32_t LL_DMA_IsActiveFlag_TEx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
uint32_t LL_DMA_IsActiveFlag_DMEx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
...
static inline
uint32_t LL_DMA_IsActiveFlag_FEx(DMA_TypeDef *DMAx, uint32_t Stream)
{
  if(Stream > 7) return;
