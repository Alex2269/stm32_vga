...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOB, VGA_GREEN0_Pin|VGA_GREEN1_Pin|VGA_GREEN2_Pin|VGA_RED0_Pin
  ...
  /**/
  GPIO_InitStruct.Pin = VGA_GREEN0_Pin|VGA_GREEN2_Pin|VGA_RED0_Pin|VGA_RED1_Pin
                          |VGA_RED2_Pin|VGA_BLUE0_Pin|VGA_BLUE1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  ...
  /**/
  GPIO_InitStruct.Pin = VGA_GREEN1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(VGA_GREEN1_GPIO_Port, &GPIO_InitStruct);
