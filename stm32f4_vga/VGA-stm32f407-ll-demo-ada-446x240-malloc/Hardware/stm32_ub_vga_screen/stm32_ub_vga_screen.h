...
#define  VGA_TIM2_HSYNC_IMP        380  // HSync-length (3,81us)
#define  VGA_TIM2_HTRIGGER_START   620  // HSync+BackPorch (5,71us)
...
// 1TIC      = 31,76us
//--------------------------------------------------------------
#define  VGA_VSYNC_PERIODE         525*2
#define  VGA_VSYNC_IMP               2*2
#define  VGA_VSYNC_BILD_START       36*2
#define  VGA_VSYNC_BILD_STOP       514*2   // (16,38ms)
