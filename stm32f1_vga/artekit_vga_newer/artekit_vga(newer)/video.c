...
void TIMER_Configuration(void)
{
	...
	*/
	...
	TimerPeriod = 2048; //2048 original
	Channel1Pulse = 144;		/* HSYNC */ //144 original
	Channel2Pulse = 391; 		/* HSYNC + BACK PORCH */ // 352 original
	...
	*/
	...
	TimerPeriod = 625;		/* Vertical lines */ //625 original
	Channel2Pulse = 2;		/* Sync pulse */ //2 original
	Channel3Pulse = 24;		/* Sync pulse + Back porch */ //24 original
	TIM_TimeBaseStructure.TIM_Prescaler = 0;
	TIM_TimeBaseStructure.TIM_CounterMode = TIM_CounterMode_Up;
	TIM_TimeBaseStructure.TIM_Period = TimerPeriod;
	TIM_TimeBaseStructure.TIM_ClockDivision = 0;
...
void SPI_Configuration(void)
{
	...
	DMA_InitStructure.DMA_Priority = DMA_Priority_Low; // low
