...
VGAParamsType VGAParams = {
	...
	24      // tune_timing additional constant
};
...
void initPWM(void)
{
	...
	// Инициализируем порт для управления светодиодом.
    /*
	...
	PORTB.GPIO_Pin = (GPIO_Pin_0 | GPIO_Pin_1); // Выходы таймера TIM3... Каналы 3 и 4
...
//    base_timer.TIM_Prescaler = SystemCoreClock / 1000000 - 1;
	...
	base_timer.TIM_Period = (hRes * factopr+VGAParams.tune_timing);
