...
//--------------------------------------------------------------
#include "main.h"
#include "stm32f7xx_ll_dma_mix.h"
...
//
//--------------------------------------------------------------
#define VGA_TIM1_PERIODE       12 // 8 // TIM1->ARR
...
set {int}0x4001002c=6            VGA_TIM1_PERIODE // TIM1->ARR
set {int}0x40000428=3            VGA_TIM3_HSYNC_PRESCALE
set {int}0x4000042c=930          VGA_TIM3_HSYNC_PERIODE
set {int}0x4000043c=125          VGA_TIM3_HSYNC_IMP
set {int}0x40000434=180          VGA_TIM3_HTRIGGER_START
...
#define  VGA_TIM3_HSYNC_PERIODE    6640
#define  VGA_TIM3_HSYNC_PRESCALE      0

#define  VGA_TIM3_HSYNC_IMP         790  // HSync-length (3,81us) TIMx->CCR3 CompareValue
#define  VGA_TIM3_HTRIGGER_START   1050  // HSync+BackPorch (5,71us) TIMx->CCR1 CompareValue
...
// 1TIC      = 31,76us
//--------------------------------------------------------------
#define  VERTICAL_VISIBLE_AREA     525 // Vertical Visible area
#define  VERTICAL_FRONT_PORCH       10 // not use
#define  VERTICAL_SYNC_PULSE         2 // Vertical Sync pulse
#define  VERTICAL_WHOLE_FRAME      540 // (16,38ms)
#define  VERTICAL_BACK_PORCH        60 // Vertical Back porch
//--------------------------------------------------------------
