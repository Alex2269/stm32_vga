...
{
  LL_RCC_SetRTCClockSource(LL_ADC_CLOCK_SYNC_PCLK_DIV1);
  ...
  */
  ...
  // ADC_InitStruct.SequencerDiscont = LL_ADC_INJ_SEQ_SCAN_DISABLE;
  LL_ADC_Init(ADCx, &ADC_InitStruct);

  /* Peripheral clock enable */
  LL_APB2_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_ADC12);
  ...
  if (ADCx == ADC1)
  {
    ...
    LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_VREFINT, LL_ADC_SAMPLINGTIME_16CYCLES_5);
...
uint16_t adc_get_value(ADC_TypeDef *ADCx, GPIO_TypeDef *GPIOx, uint32_t Pin)
{
  ...
  LL_APB2_GRP1_EnableClock(LL_AHB4_GRP1_PERIPH_GPIOA);
  LL_APB2_GRP1_EnableClock(LL_AHB4_GRP1_PERIPH_GPIOB);
  ...
  if(GPIOx == GPIOA)
  {
    if(Pin == LL_GPIO_PIN_0)
    {
      ...
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_0, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_1)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_1);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_1, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_2)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_2);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_2, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_3)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_3);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_3, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_4)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_4);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_4, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_5)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_5);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_5, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_6)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_6);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_6, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_7)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_7);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_7, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }
  ...
  if(GPIOx == GPIOB)
  {
    if(Pin == LL_GPIO_PIN_0)
    {
      ...
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_8, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }

    if(Pin == LL_GPIO_PIN_1)
    {
      LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_9);
      LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_9, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    }
  ...
  if(Pin == 0x10000) // temperature sensor
  {
    ...
    LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_TEMPSENSOR, LL_ADC_SAMPLINGTIME_2CYCLES_5);
  ...
  {
    LL_ADC_REG_SetSequencerRanks(ADCx, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_VREFINT);
    LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_VREFINT, LL_ADC_SAMPLINGTIME_2CYCLES_5);
    LL_ADC_SetCommonPathInternalCh(__LL_ADC_COMMON_INSTANCE(ADCx), LL_ADC_PATH_INTERNAL_VREFINT);
  }
